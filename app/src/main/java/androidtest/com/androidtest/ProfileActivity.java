...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Validations.ctx = ProfileActivity.this;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Fragment_Profile(), "POST");
        adapter.addFrag(new Fragment_people() , "FOLLOWERS");
        adapter.addFrag(new Fragment_people() , "FOLLOWING");
